...
import package_view.MainLibrary;
import package_view.UserView;
import package_view.UserViewBook;
...
public class UserLoginSuccess extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JOptionPane.showMessageDialog(UserLoginSuccess.this, "Please contact with the Librarian to renew the book.","Thank You", JOptionPane.ERROR_MESSAGE);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       Desktop desktop = Desktop.getDesktop();
String message = "mailto:ashik94033+library@gmail.com?subject=User%20Feedback";
URI uri = URI.create(message);
        try {
            desktop.mail(uri);
        } catch (IOException ex) {
            Logger.getLogger(UserLoginSuccess.class.getName()).log(Level.SEVERE, null, ex);
        }
